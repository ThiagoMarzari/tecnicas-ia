...
# Represta a heuristica dinamica da solucao
    ...
    def reproduzir(populacao, nova_populacao, taxa_reproducao, estado_final):
        #definir a quantidade reproduzidos
        #len(populacao)           -100
        ...
        for i in range(int(quantidade_reproduzidos / 2)+1):
          ...
          cromossomo_pai = populacao[random.randrange(len(populacao)/5 )]
